      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="#"><span class="glyphicon glyphicon-th-list"></span> Manual</a></li>
			<li><a href="../docs" target="_blank"><span class="glyphicon glyphicon-th-list"></span> Documentação</a></li>
            <li class="divider"></li>
